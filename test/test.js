...
const app = require('../root/server/server');

describe('/api/minions routes', function() {
  let fakeDb = require('../root/server/data/db.js');
...
describe('checkMillionDollarIdea middleware', function() {
  ...
  const checkMillionDollarIdea = require('../root/server/util/checkMillionDollarIdea');
...
xdescribe('BONUS: /api/minions/:minionId/work routes', function() {
  ...
  let fakeDb = require('../root/server/data/db.js').db;
